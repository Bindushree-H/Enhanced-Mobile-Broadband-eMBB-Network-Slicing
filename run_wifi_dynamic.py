...
filebase = "/testfile_" +current_time
csv_file_py = f'./testfile_2_{current_time}.csv'
csv_file_ns3 = "./scratch" + filebase + '.csv'


def main():
    #ns3ScriptName = "run_wifi_1ch.py"  # Define it here
    # Now you can use it
    print(f"Running NS3 script: {ns3_script}")
...
def simulate(arg):
    ...
    print(f"Calling the ns3 script '{ns3_script}.cc'") 
    command = f'(cd .. && ./waf --run "{ns3_script}{arguments}")'
